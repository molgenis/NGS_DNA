...
then
	...
	then
		...
		cp ${pathToFinalControls}/*/Convading/${gender}/*.aligned.only.normalized.coverage.txt ${convadingStartWithBamDir}
		cp ${pathToFinalControls}/*/Convading/${gender}/*.aligned.only.normalized.coverage.txt ${controlsDir}
