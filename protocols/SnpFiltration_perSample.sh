...
makeTmpDir "${sampleSnpsOnlyFilteredVcf}"
tmpSampleSnpsOnlyFilteredVcf="${MC_tmpFile}"
...
-R "${indexFile}" \
-O "${tmpSampleSnpsOnlyFilteredVcf}" \
-V "${sampleSnpsOnlyVcf}" \
...
mv -v "${tmpSampleSnpsOnlyFilteredVcf}" "${sampleSnpsOnlyFilteredVcf}"
