...
${EBROOTNGSMINUTILS}/vcf-compare_2.0.sh -1 /home/umcg-molgenis/NGS_DNA/PlatinumSample_True.final.vcf.gz -2 ${projectResultsDir}/variants/PlatinumSample.final.vcf.gz -o /home/umcg-molgenis/NGS_DNA/output
