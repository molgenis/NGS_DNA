...
def test_build():
    test_sample = read_sample_info("C:/Users/tyler/repos/NGS_DNA/prometheus.sample_info.yaml")
    test_header, test_body = read_samplesheet("C:/Users/tyler/Documents/160610_NB501043_0030_AH3H72BGXY.csv")
    project = get_project(test_header, test_body)
    test_altmap = read_alt_mappings("C:/Users/tyler/repos/NGS_DNA/alt_ss_field_mappings.yaml")
    test_lines = build_sample_lines(test_header, test_sample, test_altmap, project)
    add_lines(test_header, test_body, test_lines)
    return test_sample, test_header, test_body, test_lines
